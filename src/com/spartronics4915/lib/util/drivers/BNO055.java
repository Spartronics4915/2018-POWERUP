 ...
 *
 * <p>Once the sensor calibration is complete , you can get position data by by using the getAccel()
 * method. See this method definiton for usage info.
 *
 ...
 *     ===================================================================== == This is a library
 *     for the BNO055 orientation sensor
...
public class BNO055 {
  ...
  private void calculateHeadingAndPosition() {
    ...
    hx = (short) ((headingVector[0] & 0xFF) | ((headingVector[1] << 8) & 0xFF00));
    hy = (short) ((headingVector[2] & 0xFF) | ((headingVector[3] << 8) & 0xFF00));
    hz = (short) ((headingVector[4] & 0xFF) | ((headingVector[5] << 8) & 0xFF00));
    /* 1 degree = 16 LSB */
    m_heading[0] = ((double) hx) / 16.0;
    m_heading[1] = ((double) hy) / 16.0;
    m_heading[2] = ((double) hz) / 16.0;

    ax = (short) ((accelVector[0] & 0xFF) | ((accelVector[1] << 8) & 0xFF00));
    ay = (short) ((accelVector[2] & 0xFF) | ((accelVector[3] << 8) & 0xFF00));
    az = (short) ((accelVector[4] & 0xFF) | ((accelVector[5] << 8) & 0xFF00));
