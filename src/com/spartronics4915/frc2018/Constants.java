...
/**
 * A list of constants used by the rest of the robot code. This include physics constants as well as
 * constants determined through calibrations.
 */
public class Constants extends ConstantsBase {
  ...
  public static double kDriveLowGearMaxVelocity =
      3.0 * 12.0 * 60.0 / (Math.PI * kDriveWheelDiameterInches); // 6 fps
  // in RPM
  public static double kDriveLowGearMaxAccel =
      15.0 * 12.0 * 60.0 / (Math.PI * kDriveWheelDiameterInches); // 18 fps/s
  // in RPM/s
  ...
  public static final int kEncoderCodesPerRev =
      250; // Not ticks, codes; ticks would be kEncoderCodesPerRev * 4 (for quadrature encoders at
  // least)
  ...
  public static boolean kUseFlywheelAutoAimPolynomial =
  ...
  static {
    ...
    kDefaultShootingRPM =
        kFlywheelAutoAimMap.getInterpolated(
                new InterpolatingDouble(Constants.kDefaultShootingDistanceInches))
            .value;
