...
/**
 * A container class to specify the shooter angle. It contains the desired range, the
 * field_to_goal_angle
 */
public class ShooterAimingParameters {
  ...
  public ShooterAimingParameters(
      double range, Rotation2d robot_to_goal, double last_seen_timestamp, double stability) {
    this.range = range;
