...
/**
 * The LED subsystem consists of the green ring light on the front of the robot used for aiming and
 * communicating information with the drivers (when a gear is picked up, when the robot loses
 * connection) and the blue "range finding" LED strip on the back of the robot used for signaling to
 * the human player. The main things this subsystem has to do is turn each LED on, off, or make it
 * blink.
 *
 * @see Subsystem.java
 */
