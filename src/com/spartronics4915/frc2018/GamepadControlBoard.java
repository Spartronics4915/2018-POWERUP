...
/**
 * Contains the button mappings for the Gamepad control board. Like the drive code, one instance of
 * the GamepadControlBoard object is created upon startup, then other methods request the singleton
 * GamepadControlBoard instance. Implements the ControlBoardInterface.
 *
