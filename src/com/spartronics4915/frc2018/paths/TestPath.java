...
public class TestPath implements PathContainer {
  ...
  public RigidTransform2d getStartPose() {
    return new RigidTransform2d(
        ...
        Rotation2d.fromDegrees(
            90.0)); // XXX: I have no idea why this needs to be 90 instead of 180, but if it isn't
    // things get reversed
  }
  ...
  // WAYPOINT_DATA:
  // [{"position":{"x":50,"y":50},"speed":0,"radius":0,"comment":""},{"position":{"x":50,"y":90},"speed":50,"radius":20,"comment":""},{"position":{"x":90,"y":90},"speed":30,"radius":20,"comment":""},{"position":{"x":90,"y":130},"speed":30,"radius":0,"comment":""}]
  // IS_REVERSED: false
  // FILE_NAME: TestPath
}
