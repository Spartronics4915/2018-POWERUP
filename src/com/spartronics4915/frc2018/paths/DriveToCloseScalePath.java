...
public class DriveToCloseScalePath implements PathContainer {
    ...
    public RigidTransform2d getStartPose() {
        return new RigidTransform2d(new Translation2d(20, 45), Rotation2d.fromDegrees(180.0)); 
    }
    ...
    // WAYPOINT_DATA: [{"position":{"x":20,"y":45},"speed":0,"radius":0,"comment":""},{"position":{"x":50,"y":45},"speed":60,"radius":3,"comment":""},{"position":{"x":238,"y":22},"speed":60,"radius":53,"comment":""},{"position":{"x":318,"y":30},"speed":60,"radius":18,"comment":""},{"position":{"x":318,"y":53},"speed":20,"radius":0,"comment":""}]
    // IS_REVERSED: false
