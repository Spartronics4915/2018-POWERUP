...
/**
 * Uses a field and robot profile to calculate Waypoints for the paths used by the
 * GearThenHopperShoot auto modes.
 *
 * @see RobotProfile
 * @see FieldProfile
 */
public class PathAdapter {
  ...
  // Path Variables -- these will probably be common for many paths if you're only changing
  // directions
